...
ADD: spring-security jars in your project
...
[Filters are defined in web.xml whereas Interceptors are defined in applicationContext.xml]
...
applicationContext-security.xml. So try to find a bean called "springSecurityFilterChain" in the latter......and probably you can't (for instance if 
you followed a tutorial or if you configured the security using Roo)
...
URL:
----
http://localhost:8082/007-Security/001/
http://localhost:8082/007-Security/001/db (user-db, pass-db)
http://localhost:8082/007-Security/001/admin (user-admin, pass-admin)
