...
3. http://localhost:8082/010-Rest-OAuth/user/?access_token=d9719fe7-348e-4ed9-b3bf-106551dc8149
	...
	OR
	http://localhost:8082/010-Rest-OAuth/user/
	HTTP-METHOD: GET
	Accept: application/json
	Authorization: Bearer 5c476489-088d-4d2f-a0c5-84b0d3596d22
...
5. Incase client uses authorization code to get access token:
	http://localhost:8082/012-Rest-OAuth/oauth/token?grant_type=authorization_code&code=e4816e94-a352-4bbb-8f2e-00330a657029
		RESULT:
		{
		  "access_token": " 	",
		  "token_type": "bearer",
