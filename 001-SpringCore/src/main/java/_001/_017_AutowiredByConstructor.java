...
1. Instead of using XML to describe a bean wiring, you can move the bean configuration into the component class itself.
...
Differences:
@Component
This is a general-purpose stereotype annotation indicating that the class is spring component. What’s special about @Component? 
<context:component-scan> only scans @Component and do not looks for @Controller, @Service and @Repository in general. They are scanned because 
...
public class _017_AutowiredByConstructor {
	...
	//This example will throw exception: 
