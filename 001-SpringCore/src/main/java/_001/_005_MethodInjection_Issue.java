...
same prototype bean will always supplied from singleton bean. So we need a different approach when a Singleton bean has a dependency on Prototype bean.

Using Application Context Aware approach
...
class Singleton {	
	...
	public void setPrototype(Prototype3 prototype) {
