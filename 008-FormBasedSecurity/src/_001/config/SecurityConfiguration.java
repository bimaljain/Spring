...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {  
      http.authorizeRequests()
        ...
        //Spring login page. If user/password don't match, Spring MVC will keep redirecting to the login page with the error message
        .and().formLogin()
        ...
        //we don't want session to be created
