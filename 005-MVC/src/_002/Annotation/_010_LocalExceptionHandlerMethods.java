...
Handling using @ExceptionHandler, @ControllerAdvice and HandlerExceptionResolver.
...
public class _010_LocalExceptionHandlerMethods{
	...
	public ModelAndView printHello() {
		//when this exception is thrown, Spring MVC will look for an ExceptionHandler for NullPointerException in the same controller class first.
	...
	public ModelAndView printHello2() {
		//when this exception is thrown, Spring MVC will look for an ExceptionHandler for _010_CustomException in the same controller class first.
